<template>
  <div class="nav">
    <div class="nav_list">
      <div class="nav_item">
        <nuxt-link :to="{ name: 'index' }" class="name">首页</nuxt-link>
      </div>
      <div class="nav_item">
        <nuxt-link :to="{ name: 'tag' }" class="name">标签</nuxt-link>
      </div>
      <div class="nav_item">
        <nuxt-link :to="{ name: 'picture' }" class="name">相册</nuxt-link>
      </div>
      <div class="nav_item">
        <nuxt-link :to="{ name: 'link' }" class="name">友链</nuxt-link>
      </div>
      <div class="nav_item">
